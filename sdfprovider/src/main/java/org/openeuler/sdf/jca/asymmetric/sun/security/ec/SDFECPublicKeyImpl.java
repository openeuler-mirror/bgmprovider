 ...
 */
public final class SDFECPublicKeyImpl extends X509Key implements ECPublicKey {
    ...
    public SDFECPublicKeyImpl(ECPoint w, ECParameterSpec params)
     ...
     */
    public SDFECPublicKeyImpl(byte[] encoded) throws InvalidKeyException {
        decode(encoded);
    }
