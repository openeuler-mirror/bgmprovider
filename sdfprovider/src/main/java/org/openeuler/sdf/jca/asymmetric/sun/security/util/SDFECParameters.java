 ...
 */
public final class SDFECParameters extends AlgorithmParametersSpi {

    // used by SDFECPublicKeyImpl and SDFECPrivateKeyImpl
    ...
    protected void engineInit(byte[] params) throws IOException {
        ...
        if (encodedParams.tag == DerValue.tag_ObjectId) {
            ...
            SDFNamedCurve spec = SDFCurveDB.lookup(oid.toString());
            if (spec == null) {
