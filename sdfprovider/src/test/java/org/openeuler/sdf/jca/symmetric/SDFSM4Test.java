...
public class SDFSM4Test extends SDFSymmetricTest {
    ...
    // Determine whether the ciphertext value generated by sdfprovider is the same as that generated by bgmprovider
    @Test
    public void testEncryptBaseLine() throws Exception {
        testEncryptBaseLine(ALGO, BLOCK_SIZE, SDFKeyTestDB.SM4_KEY, IV_LEN);
    }
