...
public class SDFConfigRelativePathTest {
    @Test
    public void testLibraryRelativePath() {
        System.setProperty("test.sdf.library.dir", ".");
        ...
        System.getProperties().remove("test.sdf.library");
    }
}
