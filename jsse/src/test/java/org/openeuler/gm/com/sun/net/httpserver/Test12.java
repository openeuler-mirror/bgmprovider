...
public class Test12 extends Test {
    ...
    public void test() throws Exception {
        ...
        try {
            String root = Test12.class.getClassLoader().getResource("").getPath()+ "/docs";
            ...
            ctx = new SimpleSSLContext(Test12.class.getClassLoader().getResource("").getPath()).get();
            ...
            r[0] = new Runner (true, "http", root+"/test1", port, "smallfile.txt", 22);
            r[1] = new Runner (true, "http", root+"/test1", port, "largefile.txt", 2730088);
            r[2] = new Runner (true, "https", root+"/test1", httpsport, "smallfile.txt", 22);
            r[3] = new Runner (true, "https", root+"/test1", httpsport, "largefile.txt", 2730088);
            r[4] = new Runner (false, "http", root+"/test1", port, "smallfile.txt", 22);
            r[5] = new Runner (false, "http", root+"/test1", port, "largefile.txt", 2730088);
            r[6] = new Runner (false, "https", root+"/test1", httpsport, "smallfile.txt", 22);
