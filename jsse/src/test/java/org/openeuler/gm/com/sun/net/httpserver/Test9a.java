...
public class Test9a extends Test {
    ...
    public void test () throws Exception {
        ...
        try {
            String root = Test9a.class.getClassLoader().getResource("").getPath()+ "/docs";
            ...
            serverCtx = new SimpleSSLContext(Test9a.class.getClassLoader().getResource("").getPath()).get();
            clientCtx = new SimpleSSLContext(Test9a.class.getClassLoader().getResource("").getPath()).get();
            ...
            t[0] = test (true, "https", root+"/test1", port, "smallfile.txt", 22);
            t[1] = test (true, "https", root+"/test1", port, "largefile.txt", 2730088);
            t[2] = test (true, "https", root+"/test1", port, "smallfile.txt", 22);
            t[3] = test (true, "https", root+"/test1", port, "largefile.txt", 2730088);
            t[4] = test (true, "https", root+"/test1", port, "smallfile.txt", 22);
            t[5] = test (true, "https", root+"/test1", port, "largefile.txt", 2730088);
            t[6] = test (true, "https", root+"/test1", port, "smallfile.txt", 22);
            t[7] = test (true, "https", root+"/test1", port, "largefile.txt", 2730088);
            t[8] = test (true, "https", root+"/test1", port, "smallfile.txt", 22);
            t[9] = test (true, "https", root+"/test1", port, "largefile.txt", 2730088);
            t[10] = test (true, "https", root+"/test1", port, "smallfile.txt", 22);
            t[11] = test (true, "https", root+"/test1", port, "largefile.txt", 2730088);
            t[12] = test (true, "https", root+"/test1", port, "smallfile.txt", 22);
            t[13] = test (true, "https", root+"/test1", port, "largefile.txt", 2730088);
            t[14] = test (true, "https", root+"/test1", port, "smallfile.txt", 22);
