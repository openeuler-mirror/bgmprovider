...
public class Test13 extends Test {
    ...
    public void test () throws Exception {
        ...
        l.addHandler(ha);
        try {
            String root = Test13.class.getClassLoader().getResource("").getPath()+ "/docs";
            ...
            ctx = new SimpleSSLContext(Test13.class.getClassLoader().getResource("").getPath()).get();
            ...
            for (int i=0; i<NUM; i++) {
                r[i] = new Runner (true, "http", root+"/test1", port, "smallfile.txt", 22);
                r[i+NUM] = new Runner (true, "https", root+"/test1", httpsport, "smallfile.txt", 22);
            }
            start (r);
            join (r);
