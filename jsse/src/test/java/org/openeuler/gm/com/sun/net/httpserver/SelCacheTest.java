...
public class SelCacheTest extends Test {
    ...
    public void test1 () throws Exception {
        System.setProperty("sun.net.httpserver.selCacheTimeout","2");
        ...
        try {
            String root = SelCacheTest.class.getClassLoader().getResource("").getPath()+"docs";
            ...
            ctx = new SimpleSSLContext(SelCacheTest.class.getClassLoader().getResource("").getPath()).get();
            ...
            test (true, "http", root+"/test1", port, "smallfile.txt", 22);
            test (true, "http", root+"/test1", port, "largefile.txt", 2730088);
            test (true, "https", root+"/test1", httpsport, "smallfile.txt", 22);
            test (true, "https", root+"/test1", httpsport, "largefile.txt", 2730088);
            test (false, "http", root+"/test1", port, "smallfile.txt", 22);
            test (false, "http", root+"/test1", port, "largefile.txt", 2730088);
            test (false, "https", root+"/test1", httpsport, "smallfile.txt", 22);
