 ...
 */
package org.openeuler.gm.javax.net.ssl.ServerName;
...
public class EndingDotHostnameTest {

    @Test
    public void testEndingDotHostname() throws Exception {
        EndingDotHostname.main(null);
    }
}

class EndingDotHostname {
    public static void main(String[] args) throws Exception {

        try {
            Class.forName("org.openeuler.gm.javax.net.ssl.templates.TestNameService");
        }catch (Exception e){
            e.printStackTrace();
        }
