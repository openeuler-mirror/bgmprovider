...
package org.openeuler.gm.sun.security.ssl.SSLContextImpl;
...
public class CustomizedDefaultProtocolsTest {
    ...
    public void testCustomizedDefaultProtocols() throws Exception {
        System.setProperty("jdk.tls.client.protocols", "SSLv3,TLSv1,TLSv1.1,GMTLS");
...
class CustomizedDefaultProtocols {
    enum ContextVersion {
        TLS_CV_01("SSL",
                new String[] {"SSLv3", "TLSv1", "TLSv1.1", "GMTLS"}),
        TLS_CV_02("TLS",
                new String[] {"SSLv3", "TLSv1", "TLSv1.1", "GMTLS"}),
        TLS_CV_05("TLSv1.1",
