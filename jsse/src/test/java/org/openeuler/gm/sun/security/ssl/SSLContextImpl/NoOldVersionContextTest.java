...
public class NoOldVersionContextTest {
    @Test
    public void testNoOldVersionContext() throws Exception {
        System.setProperty("jdk.tls.client.protocols", "TLSv1,TLSv1.1,TLSv1.2,GMTLS");
        NoOldVersionContext.main(new String[]{});
    }
}
...
class NoOldVersionContext {
    static enum ContextVersion {
        TLS_CV_01("SSL",
                new String[] {"TLSv1", "TLSv1.1", "TLSv1.2", "GMTLS"}),
        TLS_CV_02("TLS",
                new String[] {"TLSv1", "TLSv1.1", "TLSv1.2", "GMTLS"}),
        TLS_CV_05("TLSv1.1",
