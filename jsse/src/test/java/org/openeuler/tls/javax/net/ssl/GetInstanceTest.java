...
package org.openeuler.tls.javax.net.ssl;
...
class GetInstance {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Provider p = Security.getProvider("BGMJSSEProvider");

        SSLContext context;
        context = SSLContext.getInstance("SSL");
        same(p, context.getProvider());
        context = SSLContext.getInstance("SSL", "BGMJSSEProvider");
        same(p, context.getProvider());
        ...
        kmf = KeyManagerFactory.getInstance("SunX509", "BGMJSSEProvider");
        same(p, kmf.getProvider());
        ...
        same(p, kmf.getProvider());
        kmf = KeyManagerFactory.getInstance("NewSunX509", "BGMJSSEProvider");
        same(p, kmf.getProvider());
        ...
        same(p, kmf.getProvider());
        kmf = KeyManagerFactory.getInstance("PKIX", "BGMJSSEProvider");
        same(p, kmf.getProvider());
        ...
        tmf = TrustManagerFactory.getInstance("SunX509", "BGMJSSEProvider");
        same(p, tmf.getProvider());
        ...
        same(p, tmf.getProvider());
        tmf = TrustManagerFactory.getInstance("PKIX", "BGMJSSEProvider");
        same(p, tmf.getProvider());
        ...
        same(p, tmf.getProvider());
        tmf = TrustManagerFactory.getInstance("SunPKIX", "BGMJSSEProvider");
        same(p, tmf.getProvider());
        ...
        same(p, tmf.getProvider());
        tmf = TrustManagerFactory.getInstance("X509", "BGMJSSEProvider");
        same(p, tmf.getProvider());
        ...
        same(p, tmf.getProvider());
        tmf = TrustManagerFactory.getInstance("X.509", "BGMJSSEProvider");
        same(p, tmf.getProvider());
    ...
    private static void testComSun() throws Exception {
        ...
        same(p, context.getProvider());
        context = com.sun.net.ssl.SSLContext.getInstance("SSL", "BGMJSSEProvider");
        same(p, context.getProvider());
        ...
        same(p, kmf.getProvider());
        kmf = com.sun.net.ssl.KeyManagerFactory.getInstance("SunX509", "BGMJSSEProvider");
        same(p, kmf.getProvider());
        ...
        same(p, tmf.getProvider());
        tmf = com.sun.net.ssl.TrustManagerFactory.getInstance("SunX509", "BGMJSSEProvider");
        same(p, tmf.getProvider());
