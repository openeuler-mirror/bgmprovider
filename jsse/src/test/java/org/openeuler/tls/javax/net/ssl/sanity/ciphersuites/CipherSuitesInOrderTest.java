...
package org.openeuler.tls.javax.net.ssl.sanity.ciphersuites;
...
public class CipherSuitesInOrderTest {
    @Test
    public void testCipherSuitesInOrder() throws Exception {
        CipherSuitesInOrder.main(new String[]{});
    }
}

class CipherSuitesInOrder {
