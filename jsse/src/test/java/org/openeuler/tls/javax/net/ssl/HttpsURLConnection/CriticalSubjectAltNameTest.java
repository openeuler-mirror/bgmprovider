...
package org.openeuler.tls.javax.net.ssl.HttpsURLConnection;
...
public class CriticalSubjectAltNameTest {
    @Test
    public void testCriticalSubjectAltName() throws Exception {
        CriticalSubjectAltName.main(new String[]{});
    }
}

class CriticalSubjectAltName implements HostnameVerifier {
    /*
     * =============================================================
    ...
    public static void main(String[] args) throws Exception {
        ...
        String keyFilename = pathToStores + "/" + keyStoreFile;
