package org.openeuler.tls.sun.security.ssl.SSLSessionImpl;/*
...
import org.openeuler.lib.security.SecurityUtils;
import org.openeuler.tls.javax.net.ssl.templates.SSLContextTemplate;
...
public class InvalidateSessionTest {
    ...
    public void testInvalidateSession() throws Exception {
        ...
        InvalidateSession.main(new String[]{});
    }
}

class InvalidateSession implements SSLContextTemplate {
