...
package org.openeuler.tls.sun.net.www.protocol.https.HttpsURLConnection;
...
public class IPAddressIPIdentitiesTest {
    @Test
    public void testIPAddressIPIdentities() throws Exception {
        IPAddressIPIdentities.main(new String[]{});
    }

}

class IPAddressIPIdentities {
    static Map cookies;
    ServerSocket ss;
