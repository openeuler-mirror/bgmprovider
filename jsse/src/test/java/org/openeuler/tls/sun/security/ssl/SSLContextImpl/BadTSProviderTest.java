...
public class BadTSProviderTest {
    @Test
    public void testBadTSProvider() throws Exception {
        BadTSProvider.main(new String[]{});
    }
}
...
class BadTSProvider {
     ...
     */
    static String pathToStores = BadTSProvider.class.getClassLoader()
