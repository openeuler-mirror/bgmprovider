...
package org.openeuler.tls.sun.security.ssl.SSLContextImpl;
...
public class CustomizedDefaultProtocolsTest {
    @Test
    public void testCustomizedDefaultProtocols() throws Exception {
        System.setProperty("jdk.tls.client.protocols", "SSLv3,TLSv1,TLSv1.1");
        CustomizedDefaultProtocols.main(new String[]{});
    }
}

class CustomizedDefaultProtocols {
    enum ContextVersion {
        TLS_CV_01("SSL",
        ...
        final static String[] supportedProtocols = new String[] {
                "SSLv2Hello", "SSLv3", "TLSv1", "TLSv1.1", "TLSv1.2", "TLSv1.3", "GMTLS"};
    ...
    public static void main(String[] args) throws Exception {
        ...
        Security.setProperty("jdk.tls.disabledAlgorithms", "GMTLS");
