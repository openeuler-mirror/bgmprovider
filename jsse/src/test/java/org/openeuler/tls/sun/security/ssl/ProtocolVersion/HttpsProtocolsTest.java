...
package org.openeuler.tls.sun.security.ssl.ProtocolVersion;
...
public class HttpsProtocolsTest {
    @Test
    public void testHttpsProtocols() throws Exception {
        System.setProperty("https.protocols", "SSLv3");
        HttpsProtocols.main(new String[]{});
    }
}

class HttpsProtocols implements HostnameVerifier {
