...
package org.openeuler.tls.sun.net.www.http.HttpClient;
...
public class B8025710Test {
    @Test
    public void testB8025710() throws Exception {
        B8025710.main(new String[]{});
    }
}
class B8025710 {

    private final static AtomicBoolean connectInServer = new AtomicBoolean();
    private static final String keystorefile = B8025710.class.getClassLoader()
        .getResource("tls/javax/net/ssl/etc/keystore").getPath();
