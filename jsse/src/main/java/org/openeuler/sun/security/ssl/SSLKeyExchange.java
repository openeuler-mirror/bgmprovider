...
import org.openeuler.sun.security.ssl.ECDHKeyExchange.ECDHEPossession;
...
final class SSLKeyExchange implements SSLKeyAgreementGenerator,
            ...
            if (kaPossession == null) {
                ...
                if (keyAgreement == T12KeyAgreement.RSA ||
                        keyAgreement == T12KeyAgreement.ECDH ||
                            keyAgreement == GMTLSKeyAgreement.ECC) {
                    return authentication != null ?
                            new SSLPossession[] {authPossession} :
                            new SSLPossession[0];
                } else {
    ...
    static SSLKeyExchange valueOf(
        ...
        switch (keyExchange) {
            ...
            case K_ECC:
                return SSLKeyExECC.KE;
            case K_SM2_SM2:
                return SSLKeyExSM2SM2.KE;
        }
    ...
    private static class SSLKeyExECC {
        private static SSLKeyExchange KE = new SSLKeyExchange(
                GMX509Authentication.SM2, GMTLSKeyAgreement.ECC);
    }

    private static class SSLKeyExSM2SM2 {
        private static SSLKeyExchange KE = new SSLKeyExchange(
            GMX509Authentication.SM2, GMTLSKeyAgreement.SM2);
    }
    ...
    private enum GMTLSKeyAgreement implements SSLKeyAgreement {
        RSA             ("rsa",         null,
                                        RSAKeyExchange.kaGenerator),
        ECC             ("ecc",         ECCKeyExchange.poGenerator,
                                        ECCKeyExchange.kaGenerator),
        SM2             ("sm2",         SM2KeyExchange.poGenerator,
                ...
                switch (this) {
                    case ECC:
                        return (Map.Entry<Byte,
                            ...
                            new SimpleImmutableEntry<>(
                                SSLHandshake.SERVER_KEY_EXCHANGE.id,
                                ECCServerKeyExchange.eccHandshakeConsumer
                            )
                        });
                ...
                switch (this) {
                    ...
                    case ECC:
                        return (Map.Entry<Byte,
                            ...
                            new SimpleImmutableEntry<>(
                                SSLHandshake.CLIENT_KEY_EXCHANGE.id,
                                ECCClientKeyExchange.eccHandshakeConsumer
                            )
                        });
