...
final class X509KeyManagerImpl extends X509ExtendedKeyManager
    ...
    private static class KeyType {
        ...
        boolean matches(Certificate[] chain) {
            ...
            if (GMTlsUtil.isInvalidECOrSM2Cert(keyAlgorithm, ((X509Certificate) chain[0]).getSigAlgName())) {
                return false;
            }
            if (!GMConstants.equalsAlgorithm(keyAlgorithm, chain[0].getPublicKey().getAlgorithm())) {
                return false;
            }
