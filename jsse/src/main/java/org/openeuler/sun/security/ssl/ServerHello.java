...
import org.openeuler.sun.security.ssl.SupportedVersionsExtension.SHSupportedVersionsSpec;
...
final class ServerHello {
     ...
     * The "ServerHello" handshake message producer.
     */
    private static final class GMTLSServerHelloProducer
        implements HandshakeProducer {

        // Prevent instantiation of this class.
        private GMTLSServerHelloProducer() {
            // blank
        }
    ...
    private static final
    class GMTLSServerHelloConsumer implements HandshakeConsumer {
        // Prevent instantiation of this class.
        private GMTLSServerHelloConsumer() {
            // blank
        }
