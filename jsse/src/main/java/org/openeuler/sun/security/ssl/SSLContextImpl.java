...
public abstract class SSLContextImpl extends SSLContextSpi {
    ...
    public static final class GMTLSContext extends AbstractTLSContext {
        private static final List<ProtocolVersion> clientDefaultProtocols;
        private static final List<CipherSuite> clientDefaultCipherSuites;

        static {
            clientDefaultProtocols = getAvailableProtocols(new ProtocolVersion[] {
                   ProtocolVersion.TLS13,
                   ProtocolVersion.TLS12,
                   ProtocolVersion.TLS11,
                   ProtocolVersion.GMTLS,
    ...
    private static final class DefaultManagersHolder {
        ...
        private static TrustManager[] getTrustManagers() throws Exception {
            TrustManagerFactory tmf = TrustManagerFactory.getInstance(
                    TrustManagerFactory.getDefaultAlgorithm());
            if ("BGMJSSEProvider".equals(tmf.getProvider().getName())) {
        ...
        private static KeyManager[] getKeyManagers() throws Exception {
            return KeyStoreManager.getKeyManagers();
        }
    }
