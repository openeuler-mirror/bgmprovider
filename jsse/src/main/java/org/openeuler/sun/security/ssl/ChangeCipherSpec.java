...
import org.openeuler.sun.security.ssl.SSLTrafficKeyDerivation.LegacyTrafficKeyDerivation;
...
final class ChangeCipherSpec {
    ...
    static final SSLConsumer gmtlsConsumer =
        new GMTLSChangeCipherSpecConsumer();
    static final HandshakeProducer t10Producer =
            new T10ChangeCipherSpecProducer();
    static final HandshakeProducer gmtlsProducer =
        new GMTLSChangeCipherSpecProducer();
    ...
    private static final
            class GMTLSChangeCipherSpecProducer implements HandshakeProducer {
        // Prevent instantiation of this class.
        private GMTLSChangeCipherSpecProducer() {
            // blank
        }
     ...
     */
    private static final
            class GMTLSChangeCipherSpecConsumer implements SSLConsumer {
        // Prevent instantiation of this class.
        private GMTLSChangeCipherSpecConsumer() {
            // blank
        }
