...
import org.openeuler.sun.security.ssl.CipherSuite.MacAlg;
...
abstract class Authenticator {
    ...
    // For GMTLS
    private static final
    class GMTLSMac extends GMTLSAuthenticator implements MAC {
        private final MacImpl macImpl;
        public GMTLSMac(ProtocolVersion protocolVersion,
                MacAlg macAlg, SecretKey key) throws NoSuchAlgorithmException,
                        InvalidKeyException {
            super(protocolVersion);
            this.macImpl = new MacImpl(protocolVersion, macAlg, key);
