...
public class KeyStoreDelegator extends KeyStoreSpi {
    ...
    // jdk11 KeyStoreSpi specific engineProbe method
    private static Method engineProbeMethod;
    static {
        try {
            engineProbeMethod = KeyStoreSpi.class.getDeclaredMethod("engineProbe", InputStream.class);
    ...
    public boolean engineProbe(InputStream stream) throws IOException {
        ...
        try {
            ...
            keystore = tmp;
            type = primaryType;
            if (engineProbeMethod != null) {
                result = (boolean) engineProbeMethod.invoke(keystore, stream);
            }
