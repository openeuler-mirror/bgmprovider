...
public enum ProtocolVersion {
    ...
    // TLS ProtocolVersion array for TLS 1.2 ,previous versions and GMTLS
    static final ProtocolVersion[] PROTOCOLS_TO_12_AND_GMTLS = new ProtocolVersion[] {
            TLS12, TLS11, TLS10, SSL30, GMTLS
        };
    ...
    static final ProtocolVersion[] PROTOCOLS_OF_GMTLS = new ProtocolVersion[]{
            GMTLS
    };
