...
final class TrustStoreManager {
    ...
    private static final class TrustStoreDescriptor {
        ...
        static List<TrustStoreDescriptor> createInstances() {
            ...
            List<TrustStoreDescriptor> descriptors = new ArrayList<>();
    ...
    private static final class TrustAnchorManager {
         ...
         * @return null if the underlying KeyStore is not available.
         */
        synchronized KeyStore getKeyStore(List<TrustStoreDescriptor> descriptors) throws Exception {
            if (descriptors.isEmpty()) {
                return null;
            }

            List<TrustStoreDescriptor> temporaryDescriptors = this.descriptors;
            KeyStore ks = ksRef.get();
         ...
         */
        synchronized Set<X509Certificate> getTrustedCerts(
                List<TrustStoreDescriptor> descriptors) throws Exception {
         ...
         */
        private KeyStore loadKeyStore(List<TrustStoreDescriptor> descriptors) throws Exception {
