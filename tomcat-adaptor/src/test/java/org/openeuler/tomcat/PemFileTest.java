...
public class PemFileTest extends TomcatBaseTest {
    private static final Log log = LogFactory.getLog(PemFileTest.class);

    @BeforeClass
    public static void beforeClass() {
        Assume.assumeTrue(TestUtils.isSupportPEMFile());
    }

    @Test
    public void testSM2() throws Throwable {
        Cert[] certs = new Cert[]{Cert.PEM_SM2};
    ...
    public void testSM2AndEC() throws Throwable {
        Cert[] certs = new Cert[]{Cert.PEM_SM2_EC};
        TestParameters serverParameters = new TestParameters.Builder()
