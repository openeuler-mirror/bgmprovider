...
public class CFBTest {
    ...
    public void testCFB() throws Exception {
        ...
        Cipher bcNopaddingCipher = Cipher.getInstance("SM4/CFB/NOPADDING", "BC");
        Cipher bgmNopaddingCipher = Cipher.getInstance("SM4/CFB/NOPADDING", "BGMJCEProvider");
        Cipher bcWithPaddingCipher = Cipher.getInstance("SM4/CFB/PKCS5Padding", "BC");
        Cipher bgmWithpaddingCipher = Cipher.getInstance("SM4/CFB/PKCS5Padding", "BGMJCEProvider");
