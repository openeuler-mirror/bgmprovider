...
public class OFBTest {
    ...
    public void testOFB() throws Exception {
        ...
        Cipher bcNopaddingCipher = Cipher.getInstance("SM4/OFB/NOPADDING", "BC");
        Cipher bgmNopaddingCipher = Cipher.getInstance("SM4/OFB/NOPADDING", "BGMJCEProvider");
        Cipher bcWithPaddingCipher = Cipher.getInstance("SM4/OFB/PKCS5Padding", "BC");
        Cipher bgmWithpaddingCipher = Cipher.getInstance("SM4/OFB/PKCS5Padding", "BGMJCEProvider");
