...
public class PBESameBuffer {
    ...
    private static final String[] pbeNotSM4Algorithms = {
    ...
    private static final String[] pbeSM4Algorithms = {
    ...
    @Test
    public void testNotSM4() {
        test(pbeNotSM4Algorithms, SunJCEProvider);
    }

    @Test
    public void testSM4() {
        test(pbeSM4Algorithms, BGMJCEProvider);
    }

    private static void test(String[] algorithms, String provider) {
        if (!(new PBESameBuffer().test(algorithms, provider, System.out))) {
            throw new RuntimeException("Some PBE algorithm tests failed");
        }
    }

    private boolean test(String[] algorithms, String provider, PrintStream out) {
        boolean result = true;
    ...
    private int getPadLength(String theAlgName) {
        ...
        if (theAlgName.toUpperCase().contains("SM4")) {
            return NUM_PAD_BYTES + PBKDF2_ADD_PAD_BYTES;
        }
