...
public class PBEKeysAlgorithmNames {
    ...
    private static final String[] PBE_NOT_SM4_KEY_ALGORITHMS = {
            "PBEWithMD5AndDES",
    ...
    private static final String[] PBE_SM4_KEY_ALGORITHMS = {
            "PBKDF2WithHmacSM3"
    };
    ...
    public void testNotSM4() throws Exception {
        test(PBE_NOT_SM4_KEY_ALGORITHMS, SunJCEProvider);
    }

    @Test
    public void testSM4() throws Exception {
        test(PBE_SM4_KEY_ALGORITHMS, BGMJCEProvider);
    }

    public static void test(String[] algorithms, String provider) throws Exception {
        ...
        for (String s : algorithms) {
            ...
            SecretKeyFactory skf = SecretKeyFactory.getInstance(s, provider);
