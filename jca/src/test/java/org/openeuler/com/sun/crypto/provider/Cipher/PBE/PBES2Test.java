...
public class PBES2Test {
    ...
    private static final String[] aesAlgos = {
    ...
    private static final String[] sm4Algos = {
    ...
    private static final void test(String algo, boolean suppliedParams)
        ...
        boolean isECBMode = algo.contains(ECB_MODE);
        ...
        if (suppliedParams) {
            ...
            pbeCipher.init(Cipher.ENCRYPT_MODE, pbeKey,
                    new PBEParameterSpec(salt, iterationCount, ivParameterSpec));
        } else {
            pbeCipher.init(Cipher.ENCRYPT_MODE, pbeKey);
        }
